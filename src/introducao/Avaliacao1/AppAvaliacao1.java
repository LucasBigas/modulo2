...
public class AppAvaliacao1 {
    public static void main(String[] args) {
        ...
        fase2.getListaDeConstrutores().add(cons1);
        ...
        fase2.getListaDeConstrutores().add(cons2);
        ...
        fase1.getListaDeConstrutores().add(cons3);
